...
class CMDBL2Application(Base):
    ...
    system_ownership = Column(String(300), nullable=True, comment="系统产权")
    ...
    dev_contact = Column(String(300), nullable=True, comment="系统开发接口人")
    ops_unit = Column(String(500), nullable=True, comment="应用软件层运维单位")
    ops_contact = Column(String(300), nullable=True, comment="应用软件层运维接口人")
    deployment_env = Column(String(300), nullable=True, comment="应用系统部署环境")

    # 业务信息
    business_continuity_mode = Column(String(300), nullable=True, comment="业务连续性建设模式（现状）")
    business_continuity_location = Column(String(300), nullable=True, comment="业务连续性物理部署位置（现状）")
    business_supervisor_unit = Column(String(300), nullable=True, comment="业务主管单位")
    contact_person = Column(String(200), nullable=True, comment="联系人")
    business_operation_unit = Column(String(300), nullable=True, comment="业务运营单位")
    business_operation_contact = Column(String(200), nullable=True, comment="业务运营接口人")

    # 分类信息
    other_names = Column(Text, nullable=True, comment="其他名称")
    level_1_category = Column(String(300), nullable=True, comment="一级分类")
    level_2_category = Column(String(300), nullable=True, comment="二级分类")
    level_3_category = Column(String(300), nullable=True, comment="三级分类")
    classification_situation = Column(String(500), nullable=True, comment="分类分级情况")
    upgrade_downgrade_todo = Column(Text, nullable=True, comment="升级或降级后待办")

    # 等保信息
    djbh_requirement = Column(String(500), nullable=True, comment="等保定级需求")
    ...
    # 技术信息
    has_source_code = Column(String(50), nullable=True, comment="是否有源码")
    ...
    regulatory_reputation_impact = Column(String(300), nullable=True, comment="监管和声誉影响")
    application_timeliness = Column(String(300), nullable=True, comment="应用时效要求")
    has_online_function = Column(String(100), nullable=True, comment="是否包含联机功能")
    ...
    belongs_to_platform = Column(String(300), nullable=True, comment="所属平台")
    belongs_to_capability = Column(String(300), nullable=True, comment="所属能力")

    # 改造和下线计划
    xinchuang_plan = Column(String(500), nullable=True, comment="信创改造计划")
    ...
    cloud_native_transformation = Column(String(300), nullable=True, comment="云原生改造")
